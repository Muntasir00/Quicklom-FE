...
export const GeneralPracticeTemporaryFormSchema = z.object({
    // Address fields from Geoapify API
    contract_location: z.string().optional(),
    ...
    // Auto-populated from selected_dates
    start_date: z.string()
    ...
    } else if (data.compensation_mode === "Per Hour") {
