...
import { getPublishedContractsService } from "@services/professional/PublishedContractService";
...
export const useFilterContract = (setContracts) => {
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            console.log("Professional - Submitting search with filters:", filters);
