...
export const useNursingPermanentForm = () => {
    ...
    const {
        ...
        defaultValues: {
            ...
            // Position sought - only one row for Nursing
            position_soughts: [
                {
    ...
    const onSubmit = async (data) => {
        try {
            ...
            console.log("📤 Nursing Permanent - Submitting form data:", Object.fromEntries(formData.entries()));
    ...
    const initializeStateHelper = useCallback(async () => {
        try {
            ...
            console.log("📋 Merged contract data (Nursing Permanent):", mergedContract);
            ...
            setTimeout(() => {
                ...
                console.log("📅 Nursing Permanent form reset with dates and position:", {
