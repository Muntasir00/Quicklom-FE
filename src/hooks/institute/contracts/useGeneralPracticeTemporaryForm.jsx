...
import { GeneralPracticeTemporaryFormSchema } from "@schemas/institute/GeneralPracticeTemporaryFormSchema";
...
export const useGeneralPracticeTemporaryForm = () => {
    ...
    const SELECTED_CONTRACT_TYPE = CONTRACT_TYPE.GENERAL_PRACTICE_TEMPORARY;
    ...
    const {
        ...
        resolver: zodResolver(GeneralPracticeTemporaryFormSchema),
        defaultValues: {
            contract_type: "",
    ...
    const initializeStateHelper = useCallback(async () => {
        try {
            ...
            console.log("📋 Merged contract data:", mergedContract);
            ...
            setTimeout(() => {
                ...
                console.log("📅 Form reset with dates:", {
