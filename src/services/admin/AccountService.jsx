...
export const getAccountService = async () => {
    try {
        const response = await axios.get(`/v.1/admin/account`);
...
export const updateAccount = async (formData) => {
    try {
        const response = await axios.put(`/v.1/admin/account/update`, formData);
...
export const sendVerificationTokenService = async ({ email }) => {
    try {
        ...
        const response = await axios.post(`/v.1/admin/account/send-verification-token`,  { email });
...
export const updateAccountEmail = async (formData) => {
    try {
        const response = await axios.put(`/v.1/admin/account/update/email`, formData);
