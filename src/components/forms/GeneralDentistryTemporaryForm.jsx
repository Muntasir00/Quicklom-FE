...
const GeneralDentistryTemporaryForm = ({ContractFormHook}) => {
    ...
    return (
        ...
        <style>{`
            ...
            /* Smooth scrollbar for checkbox containers */
                    ...
                    <div className="row">
                        <div className="col-md-12">
                            <div className="form-group">
                                ...
                                {contract?.data?.selected_dates && selectedDates.length > 0 && (
                ...
                <div className="card-body">
                    <div className="row">
                        ...
                        <div className="col-md-3">
                            <div className="form-group">
                                <label className="control-label font-weight-semibold">
                                  <i className="fas fa-money-bill-wave mr-2"></i>Compensation Mode <span className="text-danger">*</span>
                                </label>
                                ...
                                {errors?.compensation_mode && <div className="invalid-feedback">{errors.compensation_mode.message}</div>}
                                {watch("compensation_mode") === "Fixed Contract Value" && (
                                    <small className="form-text text-info">
                                        <i className="fas fa-info-circle mr-1"></i>
                                        Use for specific missions (e.g., wisdom teeth extraction, full mouth restoration). The value should represent the total contract value from start date to end date.
                                    </small>
                                )}
                            </div>
                        </div>
                        <div className={`col-md-3 ${watch("compensation_mode") === "Per Day" ? "" : "d-none"}`}>
                            <div className="form-group">
                                <label className="control-label font-weight-semibold">Daily Rate <span className="text-danger">*</span></label>
                                <div className="input-group">
                                    <div className="input-group-prepend">
                                        <span className="input-group-text">$</span>
                                    </div>
                                    <input {...register("daily_rate")} type="text" className={`form-control ${errors?.daily_rate ? 'is-invalid' : ''}`} placeholder="500" />
                                    <div className="input-group-append">
                                        <span className="input-group-text">CAD</span>
                                    </div>
                                </div>
                                {errors?.daily_rate && <small className="text-danger d-block mt-1"><i className="fas fa-exclamation-circle mr-1"></i>{errors.daily_rate.message}</small>}
                            </div>
                        </div>
                        <div className={`col-md-3 ${watch("compensation_mode") === "Per Hour" ? "" : "d-none"}`}>
                            <div className="form-group">
                                <label className="control-label font-weight-semibold">Hourly Rate <span className="text-danger">*</span></label>
                                <div className="input-group">
                                    <div className="input-group-prepend">
                                        <span className="input-group-text">$</span>
                                    </div>
                                    <input {...register("hourly_rate")} type="text" className={`form-control ${errors?.hourly_rate ? 'is-invalid' : ''}`} placeholder="50" />
                                    <div className="input-group-append">
                                        <span className="input-group-text">CAD</span>
                                    </div>
                                </div>
                                {errors?.hourly_rate && <small className="text-danger d-block mt-1"><i className="fas fa-exclamation-circle mr-1"></i>{errors.hourly_rate.message}</small>}
                            </div>
                        </div>
                        <div className={`col-md-3 ${watch("compensation_mode") === "Fixed Contract Value" ? "" : "d-none"}`}>
                            <div className="form-group">
                                <label className="control-label font-weight-semibold">Total Contract Value <span className="text-danger">*</span></label>
                                <div className="input-group">
                                    <div className="input-group-prepend">
                                        <span className="input-group-text">$</span>
                                    </div>
                                    <input {...register("contract_value")} type="text" className={`form-control ${errors?.contract_value ? 'is-invalid' : ''}`} placeholder="5000" />
                                    <div className="input-group-append">
                                        <span className="input-group-text">CAD</span>
                                    </div>
                                </div>
                                {errors?.contract_value && <small className="text-danger d-block mt-1"><i className="fas fa-exclamation-circle mr-1"></i>{errors.contract_value.message}</small>}
                                <small className="form-text text-muted">Total value for the entire contract</small>
                            </div>
                        </div>
                    </div>
                            ...
                            <div className="col-md-12">
                                <div className="form-group">
                                    ...
                                    <textarea
                                        ...
                                        rows="3"
                                        placeholder="Describe the specific dental mission (e.g., 'Extraction of 4 wisdom teeth', 'Full mouth restoration for patient', 'Complete denture fabrication')"
                                    ></textarea>
                                    {errors?.mission_description && (
                                        <div className="invalid-feedback">{errors.mission_description.message}</div>
                                    )}
                                    <small className="form-text text-muted">
                                        Provide details about the specific dental procedure or mission that justifies the fixed contract value.
                                    </small>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="row">
                        ...
                        <div className="col-md-6">
                            <div className="form-group">
                                ...
                                <div className="border rounded p-2 bg-white" style={{minHeight: "120px"}}>
                                    <div className="custom-control custom-checkbox mb-2">
                                        <input type="checkbox" className="custom-control-input" id="lang-english" value="English" {...register("languages")} />
                                        <label className="custom-control-label" htmlFor="lang-english">
                                            <span className="badge badge-primary mr-2">EN</span> English
                                        </label>
                                    </div>
                                    <div className="custom-control custom-checkbox mb-2">
                                        <input type="checkbox" className="custom-control-input" id="lang-french" value="French" {...register("languages")} />
                                        <label className="custom-control-label" htmlFor="lang-french">
                                            <span className="badge badge-info mr-2">FR</span> French
                                        </label>
                                    </div>
                                    <div className="custom-control custom-checkbox">
                                        <input type="checkbox" className="custom-control-input" id="lang-spanish" value="Spanish" {...register("languages")} />
                                        <label className="custom-control-label" htmlFor="lang-spanish">
                                            <span className="badge badge-warning mr-2">ES</span> Spanish
                                        </label>
                                    </div>
                                </div>
                    ...
                    <div className="row">
                                        ...
                                        <div className="custom-control custom-checkbox">
                                            <input
                                                ...
                                                onChange={(e) => {
                                                    ...
                                                    if (e.target.checked) {
                                                        setValue("software", softwareList);
                                                    } else {
                                                        setValue("software", []);
                                                    }
                                                }}
                                            />
                                            <label className="custom-control-label font-weight-semibold" htmlFor="software-select-all">
                                                <i className="fas fa-check-double text-success mr-2"></i>Select All
                                            </label>
                                        </div>
                                    </div>
                                        ...
                                        <div className="row">
                                            {[
                                                ...
                                                <div key={idx} className="col-md-6 mb-2">
                                                    <div className="custom-control custom-checkbox">
                                                        <input type="checkbox" className="custom-control-input" id={`software-${idx}`} value={software} {...register("software")} />
                                                        <label className="custom-control-label" htmlFor={`software-${idx}`}>
                                                            <i className="fas fa-laptop-code text-primary mr-2"></i>{software}
                                                        </label>
                                                    </div>
                                                </div>
                                            ))}
                        ...
                        <div className="col-md-6">
                            <div className="form-group">
                                ...
                                <textarea {...register("detailed_job_description")} className={`form-control ${errors?.detailed_job_description ? 'is-invalid' : ''}`} rows="5" placeholder="Provide comprehensive job description..."></textarea>
                            ...
                            <div className="form-group">
                                ...
                                <div className="custom-file">
                                    ...
                                    <label className="custom-file-label" htmlFor="attachments">
                                        {selectedFile ? selectedFile.name : (contract?.attachments ? contract.attachments.split('/').pop() : "Choose file...")}
                                    </label>
                                </div>

                                {/* Show selected file info */}
                                {selectedFile && (
                                    <div className="alert alert-success mt-2 py-2 px-3 d-flex align-items-center">
                                        <i className="fas fa-check-circle mr-2"></i>
                                        <div className="flex-grow-1">
                                            <small className="font-weight-bold">{selectedFile.name}</small>
                                ...
                                {/* Show existing attachment from backend */}
