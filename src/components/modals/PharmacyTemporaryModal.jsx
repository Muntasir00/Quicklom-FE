...
const PharmacyTemporaryModal = ({ show, setShow, contract }) => {
        ...
        <Modal show={show} size="xl" centered dialogClassName="contract-modal-fullscreen">
            <Modal.Header className="bg-success text-white">
                <Modal.Title className="d-flex align-items-center w-100">
                    ...
                    <div className="flex-grow-1">
                        <h5 className="mb-0 font-weight-bold">Pharmacy Temporary Contract</h5>
            ...
            <Modal.Body>
                ...
                {(hasValue(contract?.work_schedule) || hasValue(contract?.break_included) ||
                  hasValue(contract?.required_experience) || hasValue(contract?.software) ||
                        ...
                        <div className="row">
                            ...
                            {hasValue(contract?.software) && (
                                <div className="col-md-6 mb-3">
                                    <div className="card bg-light border-0">
                                        <div className="card-body py-2 px-3">
                                            <small className="text-muted d-block">Pharmacy Software</small>
                                            <strong>
                                                <i className="fas fa-laptop mr-1"></i>
                                                {formatArray(contract.software)}
                                            </strong>
                                        </div>
                                    </div>
                                </div>
                ...
                {(hasValue(contract?.compensation_mode) || hasValue(contract?.daily_rate) ||
                  hasValue(contract?.hourly_rate) || hasValue(contract?.contract_value) ||
                  hasValue(contract?.bonus_incentives) || hasValue(contract?.fees) || hasValue(contract?.parking)) && (
                    <div className="mb-4">
                        <h6 className="text-success font-weight-bold mb-3 pb-2 border-bottom">
                ...
                {(hasValue(contract?.detailed_job_description) || hasValue(contract?.additional_info)) && (
                    <div className="mb-4">
                        <h6 className="text-dark font-weight-bold mb-3 pb-2 border-bottom">
                                ...
                                <div className="col-md-12 mb-3">
                                    <div className="card bg-light border-0">
                                        <div className="card-body py-2 px-3">
                                            ...
                                            <p className="mb-0 mt-2">{contract.detailed_job_description}</p>
                                        </div>
                                    </div>
                                </div>
                            )}
...
export default PharmacyTemporaryModal;