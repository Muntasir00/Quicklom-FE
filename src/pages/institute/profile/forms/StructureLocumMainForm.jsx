...
const StructureLocumMainForm = ({ profileData, setStructureLocumMainFormData, setCurrentStep }) => {
            ...
            <div className="row">
                <div className="col-md-6">
                    <div className={`form-group${errors.province ? " has-error" : ""}`}>
                        <label htmlFor="province">Province <span className="text-red">*</span></label>
                        <input type="text" id="province" className="form-control" placeholder="Quebec / Ontario..." {...register("province")} />
            ...
            <div className="row">
                ...
                <div className="col-md-6">
                    <div className={`form-group${errors.primary_role ? " has-error" : ""}`}>
                        <label htmlFor="primaryRole">Primary Role <span className="text-red">*</span></label>
                        <select id="primaryRole" className="form-control" {...register("primary_role")}>
                            <option value="">Select Role</option>
                            <option value="institute">institute</option>
                        </select>
                        <span className={`text-danger ${errors.primary_role ? "" : "d-none"}`}>
                            {errors.primary_role && <strong>{errors.primary_role.message}</strong>}
                        </span>
                    </div>
                </div>
            </div>
            ...
            <div className="row">
                <div className="col-md-12">
                    <div className="form-group">
                        ...
                        <select className="form-control" id="contractType" {...register("contract_type")}>
