...
const Sidebar = ({...props}) => {
    ...
    const menuGroups = [
        ...
        },
        {
            title: 'Contracts',
            items:[
                {text: 'My Contracts', icon: <LayoutDashboardIcon/>, to: `/${SESSION.ROLE}/contracts`},
                {text: 'Upcoming Work', icon: <Clock3Icon/>, to: `/${SESSION.ROLE}/upcoming-contracts`,},
                {text: 'Applicants', icon: <Clock3Icon/>, to: `/${SESSION.ROLE}/contract-applicants`,},
            ]
        },
        {
            title: 'Job Board',
            items: [
                {text: 'Jobs Offers', icon: <Search/>, to: `/${SESSION.ROLE}/published-contracts`},
                {text: 'Applications', icon: <SendHorizonalIcon/>, to: `/${SESSION.ROLE}/contract-applications`},
            ]
        },
        {
            title: 'Billing & Legal',
            items: [
                {text: 'Billing & Payments', icon: <CreditCardIcon/>, to: `/${SESSION.ROLE}/billing`,},
                {text: 'Invoices', icon: <CreditCardIcon/>, to: `/${SESSION.ROLE}/billing/invoices`,},
                {text: 'Payment History', icon: <CreditCardIcon/>, to: `/${SESSION.ROLE}/billing/history`,},
...
//     BellIcon,
//     CalendarCheckIcon,
//     Clock3Icon, CreditCardIcon, FileTextIcon,
//     LayoutDashboardIcon, MailIcon,
//     Search,
//     SendHorizonalIcon,
//     Settings,
