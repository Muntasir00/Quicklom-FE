...
import { createProfessionalCategoryService } from "../../../services/admin/ProfessionalCategoryService";
...
const Create = () => {
    ...
    const onSubmit = async (data) => {
        try {
            const status = await createProfessionalCategoryService(data);
            if (status) {
    ...
    return (
        <Box sx={{ minHeight: '100vh', backgroundColor: '#f8fafc' }}>
            <PageHeader
                title={`Create ${menu}`}
                subtitle="Add a new professional category"
