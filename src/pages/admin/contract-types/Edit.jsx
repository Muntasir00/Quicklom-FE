...
import { useUpdateContractType } from "@hooks/admin/contract-types/useUpdateContractType";
    ...
    return (
        <Box sx={{ minHeight: '100vh', backgroundColor: '#f8fafc' }}>
            <PageHeader
                ...
                subtitle="Update contract type configuration"
                icon={<DescriptionRoundedIcon />}
                breadcrumbs={[
                    { label: 'Dashboard', path: `/${sessionUserRole}/dashboard` },
                    { label: 'Contract Types', path: `/${sessionUserRole}/contract-types` },
                    { label: 'Edit' },
                ]}
            />
            ...
            <Box sx={{ px: 4, pb: 4 }}>
                ...
                >
                    <CardContent sx={{ p: 3 }}>
                        <Form ContractFormHook={useUpdateContractType} contractId={id} />
                    </CardContent>
                    ...
                    >
                        <Button
                            component={Link}
                            to={`/${sessionUserRole}/contract-types`}
                            variant="outlined"
