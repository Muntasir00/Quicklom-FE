...
import { getRolesService, deleteRoleService } from "../../../services/admin/RoleService";
            ...
            renderCell: (params) => (
                <Box sx={{ display: 'flex', gap: 0.5 }}>
                    <Tooltip title="Edit">
                        <IconButton
                            size="small"
                            onClick={() => navigate(`/${userRole}/roles/${params.row.id}/edit`)}
                            sx={{
                                color: '#3b82f6',
                    ...
                    <Tooltip title="Delete">
                        <IconButton
                            size="small"
                            onClick={async () => {
                                const status = await deleteRoleService({ roleId: params.row.id });
                                if (!status) return;
    ...
    return (
        <Box sx={{ minHeight: '100vh', backgroundColor: '#f8fafc' }}>
            <PageHeader
                ...
                actionLabel="Add New"
                actionPath={`/${userRole}/roles/create`}
            />
